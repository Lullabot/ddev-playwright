...
In DDEV addons can be installed from the command line using the `ddev get` command, for example, `ddev get deviantintegral/ddev-playwright` or `ddev get ddev/ddev-drupal9-solr`.
